...
<html>
	<head>
        ...
        $(function(){            
            window.setTimeout(atualizaAlertas, 5000);
            function atualizaAlertas() {                
                $("#exibeAlertas").load('alertas_cli.php');               
                window.setTimeout(atualizaAlertas, 5000);
            }
        });
		</script>	
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<section class="navbar-header" style="height: 54px;">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
						...
						<a><span><font  color="#FFF"> MENU</span></a>
					...
					<ul class="nav navbar-nav navbar-right navbar-user">
						...
						<li class="dropdown veiculos-dropdown">
							...
							<ul class="dropdown-menu text-center">
								...
								<li class="divider"></li>
								<li id="viewrotadel" class="disabled"><a href="#" onclick="delLine()" data-toggle="modal"><i class="fa fa-circle-o"></i> Ocultar Trajeto</a></li>
								<li id="viewrotaadd" class="disabled"><a href="#" onclick="addLine()" data-toggle="modal"><i class="fa fa-circle"></i> Visualizar Trajeto</a></li>
							</ul>
						</li>
			...
			<section class="modal fade" id="modal-comandos"> 
				<section class="modal-dialog-comandos"> 
					<section class="modal-content"> 
						<section class="modal-header"> 
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<center><h3  class="modal-title"> <font  color="#000">Comandos</h3></center>
						</section>
						<section class="modal-conteudo">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <iframe height="600px" width="100%" scrolling="auto" frameborder="0" src="http://206.189.166.40/client"></iframe>
                        </div>
