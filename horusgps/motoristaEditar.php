		...
		<section id="wrapper">
			...
			<section id="page-wrapper">
				...
				<section class="container-fluid">
					...
					<section class="row">
						<section class="col-lg-12">
							<section class="alert alert-info alert-dismissable">
								...
								<i class="fa fa-info-circle"></i>  Edite as informações referentes ao motorista.
							</section>
						</section>
					</section>
					<!-- /.row -->
					...
					<section class="row">
						<form name="cadastrarNovaMotorista" method="post" onsubmit="return motoristaValida(this);" action="motoristaEditando.php?motorista=<?php echo $motoristaID; ?>">
								...
								<section class="panel panel-default">
									...
									<section class="panel-body">
										<section class="form-group">
											...
											<label>CPF</label>
											<input type="text" class="form-control" name="cpf" maxlength="14" OnKeyPress="formatar('###.###.###-##', this)" value="<?php echo $cpf; ?>">										
											...
											<select class="form-control" name="categoriaCnh">
												<option value="<?php echo $categoriaCNH; ?>"><?php echo $categoriaCNH; ?></option>
							...
							<section class="col-lg-6">
								<section class="panel panel-default">
									...
									<section class="panel-body">
										...
										<button type="submit" class="btn btn-primary" style="float: right; clear: both; margin-right: 10px; margin-bottom: 16px;"><i class="fa fa-save"></i> Editar</button>
									</section>
								</form>
							</section>
						</section>
