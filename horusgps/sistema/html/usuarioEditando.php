							...
							<section class="panel panel-default">
								...
								<section class="panel-body">
									<?php
										...
										if(!verificaPost($nome, $login, $email, $registro, $adesao, $mensalidade, $endereco,
										$celular, $telefone, $apelido, $novaSenha, $repetirSenha)|| $vencimento == "valorPadrao" || $tipoPessoa == "valorPadrao"){
											echo 
												...
												<script>usuarioEditarIncompleto()</script>";
										}
										else{
											$getHash = mysqli_query($conexao, "SELECT senha FROM usuarios WHERE id_usuario = '$userID'");
											...
											if($novaSenha != $repetirSenha){
													...
													mysqli_query($conexao, "UPDATE usuarios SET nome = '$nome', apelido = '$login', senha = '$hash', endereco = '$endereco', telefone = '$telefone', 
													celular = '$celular', tipo_pessoa = '$tipoPessoa', cpf_cnpj = '$registro', adesao = '$adesao', mensalidade = '$mensalidade', data_vencimento ='$vencimento',
													email = '$email' WHERE id_usuario = '$userID'");
													
													echo 
														"<center><img src='imagens/imgSucesso.png' alt='Sucesso' /><br /><br />
														Sucesso!<br />
														Os dados do Usuário foram alterados.<br /><br /></center>
														<script>usuarioEditarCompleto()</script>";
												}
											}
									?>
								</section>
