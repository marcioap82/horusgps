...
//$cnx = mysql_connect("localhost", "root", "aq1sw2de3") 
									...
									if ( $result <> $resultCerca And round($speed * 1.852,0) > 0 ) {
										...
										if ( $tipoEnvio == 0 ) {
											...
											while($data = mysql_fetch_assoc($consulta1)) {
												...
												$msg .= $mensagem ."<br /><br />";
												$msg .= "Equipe WAYSAT<br />";
												$msg .= "(31)3044-9029<br />";
											    $msg .= "(31)3081-1662<br />";
											    $msg .= "(31)8500-0207<br />";
												$msg .= "<a href=\"http://www.waysat.com.br\">www.waysat.com.br</a></p>";
												$msg .= "</body>";
												$msg .= "</html>";
												...
												$mail->From = "pjrastreamento@gmail.com";
												$mail->FromName = "WAYSAT-RASTREAMENTO 24hs";
												$mail->AddAddress($emailDestino);
												$mail->AddReplyTo($mail->From, $mail->FromName);
												$mail->Subject = "WAYSAT - Alerta de Violacao de Perimetro";
												$mail->Body = $msg;
							   ...
							   while($data = mysql_fetch_assoc($res)) {
								  switch ($infotext) {
									  ...
									  case "Alerta de Socorro - SOS":
										...
										break;
									  case "ht":
										$body = "Alarme de Velocidade Ativado OK";
									  ...
									  case "low battery":
										...
										break;
									  case "move":
										$body = "Seu veiculo esta em movimento!";
									  ...
									  case "nt":
										...
										break;
									  case "speed":
										$body = "Seu veiculo ultrapassou o limite de velocidade!";
										...
										break;
									  case "stockade":
										$body = "Seu veiculo saiu da cerca virtual!";
									  ...
									  case "door alarm":
										...
										break;
									  case "acc alarm":
										$body = "Seu veiculo esta com a chave ligada!";
										...
										break;
									case "acc off":
										$body = "Seu veiculo esta com a chave desligada!";
									...
									enviaEmail($emailDestino, "[WAYSAT] Alerta", $body);
								} //while
							}
						  mysql_close($cnx);
						} else {
...
function enviaEmail($destinatario, $assunto, $msgConteudo){
	...
	$mail->AddReplyTo($mail->From, $mail->FromName);
	$mail->Subject 		= "WAYSAT - Alerta ".$assunto;
