...
<html>
	<head>
		<meta charset="utf-8">
		<title>Contrato: Smart Proteção Integrada </title>
	...
	<body>
		<section style="width: 97%; margin: auto;">
			<h4 class="text-center"><strong>Contrato de rastreamento de veículos Smart Proteção Integrada e comodato de equipamentos.</strong></h4>
			<br />
			<p class="lead text-center">Contrato de Rastreamento de Veículos</p>
			<p class="text-justify">Pelo presente instrumento particular, em que são partes, de um lado Smart Proteção Integrada, pessoa jurídica de direito privado, inscrita no CNPJ sob nº. 10.455.599/0001-01, sediada à Av. Bulevar 2, 497, Conj. São Cristóvão, Fortaleza/CE, doravante denominada CONTRATADA e de outro, CONTRATANTE devidamente qualificado neste contrato, tem entre si, justo e avençado o presente contrato de rastreamento e bloqueio remoto via sistema de localização GPS e comunicação via telefonia celular móvel, bem como o comodato dos equipamentos listados no termo, doravante denominado apenas Rastreamento Veicular, mediante adesão às cláusulas e condições estabelecidas neste Contrato que reger-se-á pelas seguintes cláusulas e condições abaixo descritas:</p>
			<br />
			...
			<section class="row">
				...
				<section class="col-xs-6"><p class="text-center"><strong>Endereço:</strong> <?php echo $dados['endereco']; ?></p></section>				<section class="col-xs-6"><p class="text-center"><strong><?php echo $tipoPessoa; ?>:</strong> <?php echo $dados['cpf_cnpj']; ?></p></section>
			</section>
			<br />
			
			<h5><strong>Cláusula 1 - DO OBJETO</strong></h5>
			<p class="text-justify">1.1 – O presente instrumento tem por objeto o rastreamento e bloqueio remoto, quando contratado, via sistema com tecnologia de localização GPS e comunicação via telefonia celular móvel pela CONTRATADA ao CONTRATANTE, na área de cobertura da operadora de telefonia celular definida neste instrumento, além da cessão de direitos ao CONTRATANTE para a utilização do software de Rastreamento Veicular via Internet.</p>
			<p class="text-justify">1.2 - Fica convencionado que os serviços de rastreamento e bloqueio veicular serão prestados com a tecnologia GPS e comunicação via telefonia celular móvel.</p>
			<p class="text-justify">1.3 – Para realização dos serviços haverá o COMODATO de equipamentos devendo o contratante na oportunidade da contratação disponibilizar o veículo objeto do rastreamento, para instalação de rastreador de propriedade da CONTRATADA entregue ao CONTRATANTE na condição de comodato.</p>
			...
			<p class="text-justify">2.3 - A prestação dos serviços terá início a partir da instalação e ativação do equipamento no veículo a ser rastreado, ficando o CONTRATANTE responsável pelos efeitos do contrato em relação ao veículo descritos neste contrato, ainda que a titularidade esteja em nome de terceiros.</p>
			<br />

			<h5><strong>Cláusula 3 - DOS SERVIÇOS E RESPONSABILIDADES</strong></h5>
			<p class="text-justify">3.1 - Uma vez instalado o equipamento no veículo do CONTRATANTE, a CONTRATADA fica autorizada, de forma expressa e sem ressalvas, a rastrear o veículo, para o fim expresso neste contrato.</p>
			...
			<p class="text-justify">3.4 - O presente instrumento contratual não constitui apólice de seguro, sendo que a prestação dos serviços de rastreamento da CONTRATADA visa minimizar e tentar frustrar a possibilidade de sucesso na ocorrência de roubos e furtos veiculares e não substitui qualquer outro equipamento antifurto instalado no veículo do CONTRATANTE.</p>
			...
			<p class="text-justify">5.1 - Pela consecução integral deste Contrato, o CONTRATANTE pagará à CONTRATADA os valores descritos no ANEXO I neste instrumento, referente à habilitação, instalação, aquisição do sistema de Rastreamento Veicular, no importe de R$99,90(noventa e nove reais e noventa centavos) <?=$dados['adesao']?> e mensalidades de locação e prestação de serviços de monitoramento de acordo com as condições descritas.</p>
			...
			<p class="text-justify">9.1 - Os serviços de atendimento ao cliente serão prestados pela CONTRATADA através de seu Call Center pelo número (85) 9.8713-1757 e informado ao cliente pelo e-mail:smartprotecao@gmail.com</p>
			<br />
			...
			<p class="text-justify">11.1 - Fica eleito o Foro de Diadema - Estado do Ceará, com exclusão de qualquer outro por mais privilegiado que seja, para dirimir dúvidas de interpretação ou execução decorrentes do presente contrato.<br />
			...
			<?php
				...
				echo "<p class='text-center'>Fortaleza - CE, " . date("d") . " de $mesAtual de ". date("Y") . ".</p>";
			?>
			...
			<section class="row">
				<section class="col-xs-6">
					...
					<p class="text-center">Smart Proteção Integrada </p>
				</section>
				<section class="col-xs-6">
					<p class="text-center">_____________________________________</p>
