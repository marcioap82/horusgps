					...
					<section class="row">
						<section class="col-lg-12">
							...
							<ol class="breadcrumb">
								...
								<li>
									<i class="fa fa-user"></i> <a href="motoristaVisualizar.php">Motoristas</a>
								</li>
								<li class="active">
							...
							<section class="panel panel-default">
								...
								<section class="panel-body">
									<?php
										...
										if(strlen($nome) < 1 || strlen($email) < 1 || strlen($cpf) < 1 || strlen($endereco) < 1 || strlen($cnh) < 1 || $categoriaCnh == "ValorPadrao"){
											echo 
												...
												<script>motoristaCadastroIncompleto()</script>";
										}
										else{
											mysqli_query($conexao, "INSERT INTO motoristas (cliente, nome, email, cpf, endereco, horario_servico, cnh, categoria_cnh, ativo) VALUES ('$_SESSION[id]', '$nome', '$email', '$cpf', '$endereco', '$horarioServico', '$cnh', '$categoriaCnh', 1)");
											
											echo 
												"<center><img src='imagens/imgSucesso.png' alt='Sucesso' /><br /><br />
												Sucesso!<br />
												Os dados do motorista foram cadastrados.<br /><br /></center>
												<script>motoristaCadastroCompleto()</script>";
										}
									?>
								</section>
							</section>
