		...
		<section id="wrapper">
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				...
				<section class="collapse navbar-collapse navbar-ex1-collapse">
					<ul class="nav navbar-nav navbar-right navbar-user">
						...
						<li><a href="teste/index.php"><i class="fa fa-bar-chart"></i> Estatísticas</a></li>
			...
			<section id="page-wrapper">
				<section class="container-fluid">
					...
					<section class="row">
						<iframe width="100%" height="800px" frameborder="0" scrolling="auto" src="http://206.189.166.40/financeiro/?ng=admin/"> </iframe>
					</section>
