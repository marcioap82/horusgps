...
function usuarioEditarCompleto(userID){
    setTimeout("window.location='usuarioDetalhe.php?userid=" + userid + "'", 3500);
}

function usuarioEditarIncompleto(userID){
    setTimeout("window.location='usuarioEditar.php?userid=" + userid + "'", 4500);
}
